...
public class Main {
    ...
    public static void main(String args[]) throws IOException {
        ...
        try
        {
            //Method adapted for this problem
            long[] dist = ady.BFS_SP(""+0);
...
class AdjacencyList implements Graph {
    ...
    public long[] BFS_SP(String originVertex) throws VertexNotFoundException {
        ...
        //try {
            ...
            sourceId = Integer.parseInt(originVertex);
        ...
        boolean[] visited = new boolean[vertexCount];
        long[] link = new long[vertexCount];
