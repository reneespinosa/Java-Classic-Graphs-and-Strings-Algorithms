...
public class Main {
    ...
    public static void main(String args[]) throws IOException {
        ...
        ArrayList<Integer> pozos = new ArrayList<Integer>();
        ...
        for(int i=0;i<n;i++)
        {
            graph.get(i).add(new Edge(n,pozos.get(i)));
            graph.get(n).add(new Edge(i,pozos.get(i)));
        }


        AdjacencyList ady = new AdjacencyList(graph,n+1);

        try
        {
            long mst = ady.minimumSpanningTreeKruskal();
            writer.print(mst);
        }
        catch(Exception e)
        {
...
class AdjacencyList implements Graph {
    ...
    /* List of Node Names */
    private HashMap<String, Integer> vertexNames;
    ...
    public int search(String name) throws VertexNotFoundException {
        ...
        if (vertexNames.containsKey(name)) {
    ...
    public int insertVertex(String name) {
        ...
        if (!vertexNames.containsKey(name)) {
            ...
            vertexNames.put(name, vertexCount++);
    ...
    */
    ...
    public long minimumSpanningTreeKruskal() throws GraphNotConnectedException {
        ...
        for(EdgeExt edge: EdgeList){
            ...
            //System.out.println(edge.getStart()+" "+edge.getDestination()+" "+edge.getWeight());
    ...
    @Override
    public String getName(int nodeId)throws VertexNotFoundException{
    ...
    public HashMap<String,Integer> getVertexNames() {
        return vertexNames;
    }
...
interface Graph {
    ...
    */
    String getName(int nodeId) throws VertexNotFoundException;
