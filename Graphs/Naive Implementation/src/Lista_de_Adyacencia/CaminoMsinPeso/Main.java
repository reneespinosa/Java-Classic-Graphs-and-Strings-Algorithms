...
public class Main {
    public static void main(String[] args) {
        ...
        LINK de Envio: https://cses.fi/problemset/result/9027800/#test6
        ...
        */
        ...
        VerticeExt[] tabla = grafo.getTabla();
        int minComputadoras = (int) tabla[grafo.insVertice(Integer.toString(n))].getDist();
