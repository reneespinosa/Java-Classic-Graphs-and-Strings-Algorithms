package Lista_de_Adyacencia.BFS;
...
LINK OF SUBMISSION : https://cses.fi/problemset/result/9063535/
...
public class Main {
    public static void main(String[] args) {
        ...
        // NOTE : THERE IS A MODIFICATION OF BFS IMPLEMENTATION USED SO FAR
        ...
        for (int i = 1; i <= n; i++) {
            ...
            if (g.getTabla()[g.buscar(Integer.toString(i))].getExtra() == 0) {
                ...
                g.recorrido_amplitud(Integer.toString(i)); 
